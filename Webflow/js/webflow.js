...
!function (t) {
    ...
    var i = {}, r = {}, o = [], a = window.Webflow || [], s = window.jQuery, u = s(window), c = s(document),
        l = s.isFunction, f = i._ = n(5), d = n(1) && s.tram, h = !1, p = !1;
    ...
    window.tram = function (t) {
        ...
        var l = function (t, e, i) {
            ...
            T = /(all|none) 0s ease 0s/, O = /^(width|height)$/, E = " ", z = h.createElement("a"),
            M = ["Webkit", "Moz", "O", "ms"], A = ["-webkit-", "-moz-", "-o-", "-ms-"], j = function (t) {
                if (t in z.style) return {dom: t, css: t};
                var e, n, i = "", r = t.split("-");
                for (e = 0; e < r.length; e++) i += r[e].charAt(0).toUpperCase() + r[e].slice(1);
                for (e = 0; e < M.length; e++) if ((n = M[e] + i) in z.style) return {dom: n, css: A[e] + t}
            }, q = e.support = {
        ...
        if (q.transition) {
            var $ = q.timing.dom;
            if (z.style[$] = f["ease-in-back"][0], !z.style[$]) for (var S in d) f[S][0] = d[S]
        }
        var C = e.frame = function () {
            ...
            e.init = function (e) {
                ...
                q.backface && B.hideBackface && U(this.el, q.backface.css, "hidden")
            }, b("add", r), b("start", o), b("wait", function (t) {
                t = u(t, 0), this.active ? this.queue.push({options: t}) : (this.timer = new W({
                    duration: t,
                    context: this,
                    complete: a
                }), this.active = !0)
            ...
            function n() {
                ...
                if (r) for (C(n), e = D(), t = r; t--;) (i = u[t]) && i.render(e)
            }
        ...
        e.fallback = function (t) {
            if (!q.transition) return B.fallback = !0;
            B.agentTests.push("(" + t + ")");
        ...
        var U = t.style, Y = t.css, G = {transform: q.transform && q.transform.css}, Z = {
            color: [N, b],
        ...
        q.transform && (Z.transform = [X], Q = {
            ...
            skewX: [k],
            skewY: [k]
        }), q.transform && q.backface && (Q.z = [x, "translateZ"], Q.rotateZ = [k], Q.scaleZ = [w], Q.perspective = [y]);
        var V = /ms/, J = /s|\./;
        return t.tram = e
    }(window.jQuery)
}, function (t, e, n) {
    ...
    n(4), n(6), n(8), n(9), n(11), n(12), t.exports = n(13)
}, function (t, e, n) {
    var i = n(0);
    i.define("brand", t.exports = function (t) {
        var e, n = {}, r = t("html"), o = t("body"), a = ".w-webflow-badge", s = window.location,
            u = /PhantomJS/i.test(navigator.userAgent);

        function c() {
            var t = o.children(a), n = t.length && t.get(0) === e, r = i.env("editor");
            n ? r && t.remove() : (t.length && t.remove(), r || o.append(e))
        }

        return n.ready = function () {
            var n, i, o, a = r.attr("data-wf-status"), l = r.attr("data-wf-domain") || "";
            /\.webflow\.io$/i.test(l) && s.hostname !== l && (a = !0), a && !u && (e = e || (n = t('<a class="w-webflow-badge"></a>').attr("href", "https://webflow.com?utm_campaign=brandjs"), i = t("<img>").attr("src", "https://d1otoma47x30pg.cloudfront.net/img/webflow-badge-icon.60efbf6ec9.svg").css({
                marginRight: "8px",
                width: "16px"
 ...
 */
    ...
    i.define("forms", t.exports = function (t, e) {
        var r = {};
        n(7);
        var o, a, s, u = t(document), c = window.location, l = window.XDomainRequest && !window.atob, f = ".w-form",
            d = /e(-)?mail/i, h = /^\S+@\S+$/, p = window.alert, v = i.env(), m = /list-manage[1-9]?.com/i,
        ...
        function w(e, n) {
            var i = t(n), r = t.data(n, f);
            r || (r = t.data(n, f, {form: i})), b(r);
        ...
        function x(e, n) {
            ...
            return n = n || {}, e.find(':input:not([type="submit"])').each(function (r, o) {
                var a = t(o), s = a.attr("type"), u = a.attr("data-name") || a.attr("name") || "Field " + (r + 1),
                    c = a.val();
 ...
 */
                        ...
                        send: function (e, n) {
                            ...
                            s = new XDomainRequest, /^\d+$/.test(o.timeout) && (s.timeout = o.timeout), s.ontimeout = function () {
                                ...
                                var e = "Content-Length: " + s.responseText.length + "\r\nContent-Type: " + s.contentType,
                                    i = {code: 200, message: "success"}, r = {text: s.responseText};
                                try {
    ...
    i.define("links", t.exports = function (t, e) {
        var n, r, o, a = {}, s = t(window), u = i.env(), c = window.location, l = document.createElement("a"),
            f = "w--current", d = /^#[\w:.-]+$/, h = /index\.(html|php)$/, p = /\/$/;
    ...
    i.define("navbar", t.exports = function (t, e) {
        var n, o, a, s = {}, u = t.tram, c = t(window), l = t(document), f = i.env(),
            d = '<div class="w-nav-overlay" data-wf-ignore />', h = ".w-nav", p = "w--open", v = "w--nav-menu-open",
            m = "w--nav-link-open", g = r.triggers, w = t();
        ...
        function x(n, r) {
            ...
            s || (s = t.data(r, h, {
                ...
                return function (n, i) {
                    i = i || {};
                    var r = c.width();
                    T(t), !0 === i.open && M(t, !0), !1 === i.open && j(t, !0), t.open && e.defer(function () {
                        r !== c.width() && O(t)
                    })
                }
            }(s))) : (!function (e) {
        ...
        function E(e, n) {
            var i = t.data(n, h), r = i.collapsed = "none" !== i.button.css("display");
        ...
        function M(t, e) {
            if (!t.open) {
                ...
                var r = A(t), o = t.menu.outerHeight(!0), s = t.menu.outerWidth(!0), c = t.el.height(), f = t.el[0];
                if (E(0, f), g.intro(0, f), i.redraw.up(), a || l.on("tap" + h, t.outside), !e) {
                    ...
                    var b = c + o;
                    u(t.menu).add(d).set({y: -b}).start({y: 0})
                }
            }
        }

        function A(t) {
            var e = t.config, i = e.docHeight ? l.height() : n.height();
        ...
        function j(t, e) {
            if (t.open) {
                ...
                if (n.animOver) u(t.menu).add(i).start({x: o * n.animDirect}).then(c); else {
                    var s = a + r;
    ...
    i.define("scroll", t.exports = function (t) {
        ...
        function s(e, s) {
            if (a.test(e)) {
                var u = t("#" + e);
                if (u.length) {
                    if (s && (s.preventDefault(), s.stopPropagation()), r.hash !== e && o && o.pushState && (!i.env.chrome || "file:" !== r.protocol)) (o.state && o.state.hash) !== e && o.pushState({hash: e}, "", "#" + e);
            ...
            ready: function () {
                ...
                e.on("click", "a", function (e) {
                    if (!(i.env("design") || window.$.mobile && t(e.currentTarget).hasClass("ui-link"))) if ("#" !== this.getAttribute("href")) {
                        var r = this.href.split("#"), o = r[0] === n ? r[1] : null;
                        o && s(o, e)
    ...
    i.define("slider", t.exports = function (t, e) {
            ...
            return function (r, a) {
                ...
                if (o && "setting" === r.type) {
                    ...
                    !function (n, i) {
                        ...
                        }), null != r && O(n, {index: r, immediate: !0})
                    }(n, a.select)
                } else {
                    if ("swipe" === r.type) {
                    ...
                    n.nav.has(r.target).length && O(n, {index: t(r.target).index()})
                }
            }
        }
        ...
        function O(e, n) {
            ...
            if (e.index !== e.previous) {
                if ("cross" === w) {
                    var T = Math.round(y - y * i.crossOver), O = Math.round(y - T);
                    return k = "opacity " + T + "ms " + b, c(m).set({visibility: ""}).add(k).start({opacity: 0}), void c(v).set({
                        visibility: "",
                        x: d,
                        opacity: 0,
                        zIndex: e.depth++
                    }).add(k).wait(O).then({opacity: 1}).then(E)
                }
        ...
        function z(e) {
            ...
            var c = e.index;
            c >= n && (c = n - 1), O(e, {immediate: !0, index: c})
        }
            ...
            return n ? null : (e = "string" == typeof e ? t(e).get(0) : e) ? new function (t) {
                ...
                function f(t) {
                    if (a) {
                        ...
                        var l = t.touches, f = l ? l[0].clientX : t.clientX, d = l ? l[0].clientY : t.clientY,
                            p = f - o;
                        o = f, Math.abs(p) > c && i && "" === String(i()) && (r("swipe", t, {direction: p > 0 ? "right" : "left"}), h()), (Math.abs(f - e) > 10 || Math.abs(d - n) > 10) && (s = !0)
                    }
                }
